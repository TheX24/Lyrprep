...
#### Enable "Dev Mode" in the extension's settings and upload your TTML file by clicking on the "`<>`" button at the top (default to be on the top but it's a setting, so might be at the bottom for you) of the lyrics page, then click on "Upload" and select the file.
#### If it has uploaded and parsed successfully, all the lines are in place, and there are no errors, then go to the "[create-a-ticket](https://discord.com/channels/1369992682214264993/1420470843414413403)" channel in the Spicy Lyrics Discord Server.
