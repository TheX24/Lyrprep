...
Made by **[@Balint2201](https://github.com/Balint2201)**<br>
...
## 1. Upload a song
![A GIF showing how to upload a song to the AMLL TTML Tool website.](../../media/balint2201/guide/AudioImport.gif)
> [!TIP]
...
>
> ![An image showing the AMML TTML Tool's "Import via plain text" settings with the "Enable Special Prefix" on.](../../media/balint2201/guide/enablespecialprefix.png)

For most of the time, you will be importing lyrics via plain text, prepared by [Lyrprep](https://lyrprep.spicylyrics.org/)

![A GIF showing how to use "Import via plain text" feature on the AMLL TTML Tool website.](../../media/balint2201/guide/TextImport.gif)
...
![A GIF showing how to switch to the "Sync Mode" / "Time" tab and select the first word on the AMLL TTML Tool website](../../media/balint2201/guide/SyncTab.gif)
Main keybinds:
...
![A GIF showing how to add the "songwriters" metadata on the AMLL TTML Tool website.](../../media/balint2201/guide/websitecredits.gif)

<details>
<summary>Adding songwriters manually (NOT ADVISED)</summary>
...
> ![A GIF showing how to get the songwriters from Spotify.](../../media/balint2201/guide/writtenby.gif)
...
<h6>This guide is improving over time, some parts might and will change. Thanks for reading, have a great time making some TTMLs for the community.</h6>
