...
> - To get lyrics via a Spotify link, you need to log in at [interface.spicylyrics.org](https://interface.spicylyrics.org/dashboard/tools/lyrprep) (this page will be available even when you aren't an official TTML Maker yet).
